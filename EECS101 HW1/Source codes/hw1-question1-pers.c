...
int main(int argc, char **argv)
{
	...
	for (t = 0.01; t < 20000.01; t += .01)  //change the t range
	{
	...
	ofile = "hw1-question1-persp.ras";// this is the name of your output file, modify the name according to the requirements
