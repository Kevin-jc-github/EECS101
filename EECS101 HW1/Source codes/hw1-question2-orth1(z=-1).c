...
{
	int				i;
	float			t, x,x_bar,x_bar_prime, y_bar_prime,xprime,y,y_bar,yprime, z,z_bar;
	float 			fprime = 1;
	FILE			*fp;
	char			 *ofile;
	...
	for (t = 0.01; t < 10000.01; t += .01)  //change the t range
	{
		...
		xprime = x;			/* this is an orth projection */
		yprime = y;		
	...
	ofile = "hw1-question2-orth1.ras";// this is the name of your output file, modify the name according to the requirements
